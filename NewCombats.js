    ...
    g_socket.onmessage = function(msg) { 
      ...
      switch (command){
        ...
        case "gmst":
          ...
          J("#ecran_lancer_combat").css('display', 'none'); 
          J("#cache_menu").css('display', 'none');							          
          break;
        case "uwin":
          partiefinie=true;
          gameOver(true);
          ...
          switch(idaction){
            ...
            case 11:
              ...
              for (var i = 0; i < length; i++) {
                valeurs[i] =parseInt(params[2*i]);
                if (bateau.sens==1){
                  cibles[i]= g_bateauxEnnemis[params[2*i+1]]; 
                }else{
                  cibles[i]=g_bateauJoueur;
                }
              }
              
              bateau.sortIfrit(cibles, valeurs);
              cibles=null;
              valeurs=null;
              break;
            case 12:
              ...
              bateau.sortMyquo(cibles, valeurs);
              cibles=null;
              valeurs=null;
              break;
          }
